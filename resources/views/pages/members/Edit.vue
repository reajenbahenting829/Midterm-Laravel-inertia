<template layout="default">
    <div class="container bg-indigo-900 w-[600px] shadow p-10 mx-auto mt-5">
        <h1 class="text-2xl font-bold text-white mb-5 text-center">Edit Member</h1>
        <form @submit.prevent="updateMember">
            ...
            <div class="flex flex-col mb-4">
                <label class="font-bold text-white mb-2" for="last_name">Last Name:</label>
                <input
            ...
            <div class="flex flex-col mb-4">
                <label class="font-bold text-white mb-2" for="company_id">Company:</label>
                <select
...
const updateMember = () => {
    Inertia.post(`/members/${props.member.id}`, {
        _method: "put",
